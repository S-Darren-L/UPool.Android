package com.upool.android.upool.Services;
...
/**
 * Created by Darren on 7/13/2017.
 */
...
public class FetchAddressIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Location location = intent.getParcelableExtra(ServiceConstants.LOCATION_DATA_EXTRA);
        ...
        // Make sure that the location data was really sent over through an extra. If it wasn't, send an error error message and return.
        if (location == null) {
            errorMessage = getString(R.string.no_location_data_provided);
            Log.wtf(TAG, errorMessage);
            deliverResultToReceiver(ServiceConstants.FAILURE_RESULT, errorMessage);
            return;
        }
